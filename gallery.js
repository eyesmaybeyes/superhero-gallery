...
document.addEventListener("DOMContentLoaded", function (event) {
    ...
    for (let item of gallery) {
        ...
        <div class="rating">
                <input type="radio" id="${item.idstar_1}" name="${item.naming}" />
                <label for="${item.idstar_1}">☆</label>
                <input type="radio" id="${item.idstar_2}" name="${item.naming}" />
                <label for="${item.idstar_2}">☆</label>
                <input type="radio" id="${item.idstar_3}" name="${item.naming}" />
                <label for="${item.idstar_3}">☆</label>
                <input type="radio" id="${item.idstar_4}" name="${item.naming}" />
                <label for="${item.idstar_4}">☆</label>
                <input type="radio" id="${item.idstar_5}" name="${item.naming}" />
                <label for="${item.idstar_5}">☆</label>
            </div>
